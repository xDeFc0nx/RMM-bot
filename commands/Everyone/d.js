...
module.exports = {
  name: "d", //the command name for execution & for helpcmd [OPTIONAL]
    ...
    Wallet.exists({ memberId: message.author.id }).then(async (x) => {
      if (x) {
        ...
        const send = new MessageEmbed()
          .setColor("GREEN")
          .setDescription(` Thank you for bumping the server, You earned 500 Dirham`)
          .setFooter(
